    ...
    while (true) {
        ...
        if (r.type === 'SERVER_ACTION' && r.act?.action_id === 'help') {
            ...
            if (exer.includes('hands1')) 
                rsp.msg = `${(appeal === 'official' ? 'Делайте' : 'Делай')} вращения плечами. Для этого ${(appeal === 'official' ? 'положите' : 'положи')} свои ру'ки на плечи и ${(appeal === 'official' ? 'вращайте' : 'вращай')} их в одну сторону. Затем ${(appeal === 'official' ? 'повторяйте' : 'повторяй')} то же самое, только в другую сторону`
            else if (exer.includes('hands2'))
                rsp.msg = `${(appeal === 'official' ? 'Делайте' : 'Делай')} рывки руками в сторону. Для этого ${(appeal === 'official' ? 'согните' : 'согни')} ру'ки в локтях, ${(appeal === 'official' ? 'сделайте' : 'сделай')} пару рывков. Затем ${(appeal === 'official' ? 'разомкните' : 'разомкни')} ру'ки и ${(appeal === 'official' ? 'сделайте' : 'сделай')} так же пару рывков. При этом во время широких рывков можно поворачиваться корпусом вправо или влево`
            else if (exer.includes('hands3'))
                rsp.msg = `${(appeal === 'official' ? 'Делайте' : 'Делай')} рывки руками вверх и вниз. Для этого одну руку ${(appeal === 'official' ? 'опустите' : 'опусти')} вниз, а другую ${(appeal === 'official' ? 'поднимите' : 'подними')} вверх. После сделанных рывков ${(appeal === 'official' ? 'поменяйте' : 'поменяй')} ру'ки местами`
            else if (exer.includes('head1'))
                rsp.msg = `${(appeal === 'official' ? 'Делайте' : 'Делай')} вращения головой. Для этого ру'ки ${(appeal === 'official' ? 'положите' : 'положи')} на талию и ${(appeal === 'official' ? 'вращайте' : 'вращай')} головой по часовой стрелке. Затем ${(appeal === 'official' ? 'повторите' : 'повтори')} это уже против часовой стрелки`
            else if (exer.includes('circling1'))
                rsp.msg = `${(appeal === 'official' ? 'Делайте' : 'Делай')} вращения тазом. Для этого ру'ки ${(appeal === 'official' ? 'положите' : 'положи')} на талию и ${(appeal === 'official' ? 'вращайте' : 'вращай')} тазом по часовой стрелке. Затем ${(appeal === 'official' ? 'повторите' : 'повтори')} это уже против часовой стрелки`
            else if (exer.includes('circling2'))
                rsp.msg = `${(appeal === 'official' ? 'Делайте' : 'Делай')} вращения корпусом. Для этого ру'ки ${(appeal === 'official' ? 'сомкните' : 'сомкни')} в кулак перед собой и ${(appeal === 'official' ? 'сделайте' : 'сделай')} повороты корпуса сначало влево, а затем вправо`
            else if (exer.includes('hands4'))
                rsp.msg = `${(appeal === 'official' ? 'Делайте' : 'Делай')} вращения кистей. Для этого ру'ки ${(appeal === 'official' ? 'сомкните' : 'сомкни')} в кулак перед собой и ${(appeal === 'official' ? 'вращайте' : 'вращай')} кистями по часовой стрелке. Затем ${(appeal === 'official' ? 'повторите' : 'повтори')} это уже против часовой стрелки`
            else if (exer.includes('legs1'))
                rsp.msg = `${(appeal === 'official' ? 'Делайте' : 'Делай')} махи ногами. Для этого ру'ки ${(appeal === 'official' ? 'положите' : 'положи')} на талию и ${(appeal === 'official' ? 'поднимите' : 'подними')} сначала одну ногу, а затем другую`
            else if (exer.includes('legs2'))
                rsp.msg = `${(appeal === 'official' ? 'Делайте' : 'Делай')} выпады. Для этого ру'ки ${(appeal === 'official' ? 'положите' : 'положи')} на талию и ${(appeal === 'official' ? 'сделайте' : 'сделай')} шаг вперёд. Затем одну ногу ${(appeal === 'official' ? 'согните' : 'согни')} в колене под девяносто граудосв. Затем ${(appeal === 'official' ? 'поменяйте' : 'поменяй')} ногу`
                ...
                rsp.msg = `${(appeal === 'official' ? 'Делайте' : 'Делай')} прыжки. Для этого ру'ки ${(appeal === 'official' ? 'положите' : 'положи')} на талию и ${(appeal === 'official' ? 'сделайте' : 'сделай')} несколько прыжков. Можно прыгать как на двух ногах, так и на одной`
